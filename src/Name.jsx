...
export default function Name() {
  return (
    <div className="min-h-[100vh] flex flex-col justify-center items-center text-center pb-10 mx-1 sm:pb-0 gap-3 snap">
      ...
      data-aos="flip-down" />
      <h1 className="text-4xl sm:text-7xl font-bold z-20"
      data-aos="zoom-in"
      data-aos-delay={500}>Ryan Bulluss</h1>
      <h2 className="text-3xl sm:text-5xl text-gray-400 z-20"
      data-aos="zoom-in"
      data-aos-delay={750}>Full Stack Software Engineer</h2>
